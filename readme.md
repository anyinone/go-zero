...
```shell
go get -u github.com/anyinone/go-zero
```
## Upgrade
...
```shell
go install github.com/anyinone/go-zero/tools/goctl@latest
```
...
2. install goctl
   ...
   GO111MODULE=on go get -u github.com/anyinone/go-zero/tools/goctl@latest
