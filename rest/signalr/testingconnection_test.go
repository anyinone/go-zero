	...
	return func() {
		...
		for {
			if message, err := conn.ClientReceive(); err == nil {
				...
				if err = jsoniter.Unmarshal([]byte(message), &hubMessage); err == nil {
					switch hubMessage.Type {
					case 1, 4:
						var invocationMessage invocationMessage
						if err = jsoniter.Unmarshal([]byte(message), &invocationMessage); err == nil {
					...
					case 2:
						...
						if err = jsoniter.Unmarshal([]byte(message), &jsonStreamItemMessage); err == nil {
					...
					case 3:
						...
						if err = jsoniter.Unmarshal([]byte(message), &completionMessage); err == nil {
					...
					case 7:
						...
						if err = jsoniter.Unmarshal([]byte(message), &closeMessage); err == nil {
