...
import (
	...
	"github.com/anyinone/go-zero/core/jsonx"
	"github.com/anyinone/go-zero/core/lang"
	"github.com/anyinone/go-zero/core/stringx"
...
func (u *Unmarshaler) processFieldPrimitive(field reflect.StructField, value reflect.Value,
	...
	default:
		...
		case json.Number:
			return u.processFieldPrimitiveWithJSONNumber(field, value, jsoniter.Number(v.String()), opts, fullName)
...
func fillPrimitive(fieldType reflect.Type, value reflect.Value, mapValue interface{},
	...
	if fieldType.Kind() == reflect.Ptr {
		...
		case string, json.Number, jsoniter.Number:
			value.Set(target.Addr())
			value = target
		}
	}
	...
	case json.Number:
		if err := validateJsonNumberRange(jsoniter.Number(v.String()), opts); err != nil {
			return err
		}
