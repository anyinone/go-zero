...
import (
	...
	"github.com/anyinone/go-zero/core/fx"
	"github.com/anyinone/go-zero/core/logx"
	"github.com/anyinone/go-zero/core/stat"
	"github.com/anyinone/go-zero/core/stores/cache"
	"github.com/anyinone/go-zero/core/stores/redis"
	"github.com/anyinone/go-zero/core/stores/redis/redistest"
	"github.com/anyinone/go-zero/core/stores/sqlx"
...
func TestCachedConnQueryRow(t *testing.T) {
	...
	assert.Nil(t, err)
	var actual string
	assert.Nil(t, jsoniter.Unmarshal([]byte(actualValue), &actual))
